...
interface IdolApi {
    companion object {
         ...
         * return [IdolApi]
         * */
        operator fun invoke(): IdolApi {
            val logger = HttpLoggingInterceptor(object : HttpLoggingInterceptor.Logger {
                override fun log(message: String) {
                    Logger.d("IdolComplex Api", message)
                }
            }).apply {
...
//                if (host.startsWith("capi-v2.")) host = host.replaceFirst("capi-v2.", "chan.")
            ...
            return Retrofit.Builder()
                ...
                .build()
                .create(IdolApi::class.java)
        }
    }

    @GET
    suspend fun getPosts(@Url httpUrl: HttpUrl): Response<MutableList<PostIdol>>
    ...
    @GET
    fun getTags(@Url httpUrl: HttpUrl): Call<MutableList<TagIdol>>
