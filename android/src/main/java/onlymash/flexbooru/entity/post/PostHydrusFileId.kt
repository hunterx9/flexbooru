...
data class PostHydrusFileId(
    ...
    override fun getPreviewUrl(): String =
        checkUrl("http://192.168.100.122:45869/get_files/file?Hydrus-Client-API-Access-Key=067fde0b3e566f5dd4a3874621669e33b710286b0b5d7cd201b414b6541347a4&file_id=" + file_ids[0])
